                        ...
                        <div className="flex flex-col gap-5">
                            {skillGroups.map((g, i) => (
                                <motion.button
                                    ...
                                    className={`text-left px-8 py-5 rounded-2xl border transition-all duration-300 ${activeGroup === i
                                        ? "border-cyan-400/40 bg-cyan-400/10 text-white shadow-lg"
                                        : "border-white/5 bg-white/[0.02] text-slate-500 hover:text-white hover:border-white/20"
                                        }`}
                                    whileHover={{ x: 3 }}
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-4 justify-center max-w-4xl mx-auto">
                            {badgeSkills.map((s, i) => (
                                <motion.span
                                    key={s.name}
                                    className="tech-badge flex items-center gap-2 px-4 py-2 cursor-default"
